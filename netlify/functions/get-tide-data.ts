...
export default async (request: Request, context: Context) => {
	try {
		...
		if (!ADMIRALTY_API_KEY) {
			console.warn('ADMIRALTY_API_KEY not configured, using calculated tides');
 ...
 */
function generateCalculatedTides(lat: string, lng: string, start: string, end?: string | null): Response {
	try {
